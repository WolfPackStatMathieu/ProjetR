...
Toujours sur la table `hdv2003`, entre la variable comptabilisant le nombre de frères et sœurs et celle comptabilisant le nombre d’heures passées devant la télévision, laquelle a la valeur moyenne la plus élevée ?
...
La table hdv2003 comporte-t-elle des valeurs manquantes ? 
```{r exoh3,exercise=TRUE,exercise.eval=FALSE, exercise.startover = TRUE, exercise.reveal_solution =FALSE}
...
quiz(caption = "Manquantes, vous avez dit manquantes ?",
  question(text = " Y a-t-il des variables de la table hdv2003 ayant des valeurs manquantes ?",
    answer(text = "Non, et je ne sais pas pourquoi", message = "FAUX !"),
    answer(text = "Oui, et je ne sais pas quoi ajouter", message = "Cherche un peu plus" ),
    answer(text= "heures.tv", correct = TRUE),
    answer(text = "age", message = "Presque !"),
    answer(text = "nivetud", message = "Presque !"),
    answer(text = "hard.rock", message = "Presque !"),
    allow_retry = TRUE,
    random_answer_order = TRUE,
    post_message = random_praiseFR()
