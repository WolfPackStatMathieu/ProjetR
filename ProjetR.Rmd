...
quiz(caption = "Summary et l'allure de la distribution",
...
```{r exercice7, exercise=TRUE, exercise.eval=FALSE}
...
```{r exemple1, exercise = FALSE, exercise.eval=FALSE}
mon_skim <- skim_with(
...
```{r exemple2, exercise=FALSE, exercise.eval=FALSE}
...
-->
```{r exemple3, exercise=TRUE, exercise.eval=FALSE}
...
```{r exercice8-ecart, exercise=TRUE, exercise.eval = FALSE}
...
```{r exercice-supplementaire, exercise=TRUE, exercise.eval=FALSE}
